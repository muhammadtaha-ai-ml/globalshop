  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DataSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (sensorType == null) return _deviceNotFound(context);
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: isWater
                        ? GridView.count(
                            ...
                            children: [
                              _modernCard(
                                ...
                                subtitle: "Monitor",
                                imagePath:
                                    'assets/uploads/water_level.png',
                                gradient: const LinearGradient(
                                  colors: [
                                    Color(0xFFE3F2FD),
                                    Color(0xFFBBDEFB)
                        ...
                        : isGas
                            // ✅ Gas card now uses imagePath just like water cards
                            ? GridView.count(
                                crossAxisCount: 2,
                                crossAxisSpacing: 14,
                                mainAxisSpacing: 14,
                                ...
                                children: [
                                  _modernCard(
                                    ...
                                    title: "Gas Monitor",
                                    subtitle: "Safety",
                                    // ✅ CHANGED: imagePath instead of icon
